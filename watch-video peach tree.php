...
<section class="watch-video">
   <div class="video-container">
      <div class="video">
         <video src="<?php echo htmlspecialchars($video['video_path']); ?>" controls poster="<?php echo htmlspecialchars($video['thumbnail']); ?>" id="video"></video>
      </div>
...
<section class="comments">
   ...
   <div class="box-container">
      <?php
      $stmtComments = $conn->prepare("SELECT * FROM comments WHERE video_id = ? ORDER BY created_at DESC");
      $stmtComments->bind_param("i", $video_id);
      ...
      while ($comment = $resultComments->fetch_assoc()): ?>
         <div class="box">
            <div class="user">
               ...
               <div>
                  <h3><?php echo htmlspecialchars($comment['student_name']); ?></h3>
                  <span><?php echo htmlspecialchars($comment['created_at']); ?></span>
               </div>
            </div>
            <div class="comment-box"><?php echo htmlspecialchars($comment['comments']); ?></div>
...
if (isset($_POST['add_comment'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO comments (video_id, student_name, comments) VALUES (?, ?, ?)");
    $stmt->bind_param("iss", $video_id, $student_name, $comment);
    if ($stmt->execute()) {
...
<section class="watch-video">
   <div class="video-container">
      <div class="video">
         ...
         <video src="assets/images_courses/Peach Tree/20240326_164628.mp4" controls poster="assets/images_courses/Peach Tree/Peachtree-logo.jpg" id="video"></video>
        </div>
      <h3 class="title">peach tree tutorial (part 01)</h3>
      <div class="info">
